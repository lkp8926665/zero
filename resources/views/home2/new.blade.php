...
@section('info')
    <title>{{$field->art_title}}--{{\Illuminate\Support\Facades\Config::get('web.web_title')}}-{{Config::get('web.seo_title')}}</title>
    <meta name="keywords" content="{{$field->art_tag}}--{{Config::get('web.keywords')}}" />
    <meta name="description" content="{{$field->art_description}}--{{Config::get('web.description')}}" />
@endsection
@section('content')
<article class="blogs">
    <h1 class="t_nav2">
