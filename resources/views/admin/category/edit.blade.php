	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap fr">
                <a href="{{url('admin/category/create')}}"><i class="fa fa-plus"></i>分类添加</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                @foreach($data as $pid)
                                    <option value="{{$pid->cate_id}}" @if($pid->cate_id==$field->cate_pid) selected @endif>{{$pid->_cate_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
