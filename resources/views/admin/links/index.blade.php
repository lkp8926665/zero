        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    <a href="{{url('admin/links/create')}}"><i class="fa fa-plus"></i>友情链接添加</a>
                    <a href="{{url('admin/links')}}"><i class="fa fa-recycle"></i>刷新</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text" name="ord[]" value="{{$v->link_order}}" onchange="changeOrder(this,{{$v->link_id}})">
                        </td>
                        ...
                        <td>
                            ...
                            <a href="javascript:" onclick="del_links({{$v->link_id}})">删除</a>
                        </td>
                    </tr>
                    @endforeach
