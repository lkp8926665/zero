	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap fr">
                <a href="{{url('admin/category/create')}}"><i class="fa fa-plus"></i>文章添加</a>
                <a href="{{url('admin/category')}}"><i class="fa fa-list-ul"></i>文章列表</a>
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>编辑：</th>
                        <td>
                            <input type="text" class="sm" name="art_editor" value="{{$field->art_title}}">
                        </td>
                    </tr>
                    <tr>
                        <th>缩略图：</th>
